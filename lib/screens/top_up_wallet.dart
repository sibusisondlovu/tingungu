          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(12),
                borderSide: const BorderSide(color: Color(0xFFD4AF85), width: 2),
              ),
              filled: true,
          ...
          children: _quickAmounts.map((amount) {
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isSelected ? const Color(0xFFD4AF85) : Colors.white,
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                    color: isSelected ? const Color(0xFFD4AF85) : Colors.grey[300]!,
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                    color: isSelected ? Colors.white : const Color(0xFFD4AF85),
                  ),
                ),
              ),
            );
  ...
  Widget _buildDisclaimerCard() {
    return Container(
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: const Color(0xFFD4AF85).withOpacity(0.3)),
      ),
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            height: 24,
            decoration: BoxDecoration(
              color: _agreedToTerms ? const Color(0xFFD4AF85) : Colors.white,
              borderRadius: BorderRadius.circular(6),
              border: Border.all(
                color: _agreedToTerms ? const Color(0xFFD4AF85) : Colors.grey[400]!,
                width: 2,
              ),
            ),
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          ...
          elevation: 2,
          shadowColor: const Color(0xFFD4AF85).withOpacity(0.4),
        ),
        child: const Text(
          'Continue to Payment',
          style: TextStyle(
